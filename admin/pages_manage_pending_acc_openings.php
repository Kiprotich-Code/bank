              ...
              <div class="card-body">
                <table id="example1" class="table table-hover table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    //fetch all iB_Accs
                    $ret = "SELECT * FROM  iB_bankAccounts WHERE acc_status='Pending' ORDER BY RAND() ";
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>
                            <form action="update_account_status.php" method="post">
                                <input type="hidden" name="account_id" value="<?php echo $row->account_id; ?>">
                                
                                <button type="submit" name="acc_status" value="Active" class="btn btn-success btn-sm mb-2">
                                    <i class="fas fa-check"></i> Activate
                                </button>
                                <button type="submit" name="acc_status" value="Rejected" class="btn btn-danger btn-sm">
