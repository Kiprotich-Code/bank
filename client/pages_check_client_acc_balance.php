                                        ...
                                        <div class="col-12 table-responsive">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Kshs <?php echo $deposit; ?></td>
                                                        <td>Kshs <?php echo $withdrawal; ?></td>
                                                        <td>Kshs <?php echo $Transfer; ?></td>
                                                        <td>Kshs <?php echo $money_in; ?></td>
                                                    </tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Kshs <?php echo $rate_amt; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Total Balance:</th>
                                                        <td>Kshs <?php echo $totalMoney; ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
